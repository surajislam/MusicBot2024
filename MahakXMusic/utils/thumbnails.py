...
async def get_thumb(videoid):
    ...
    arial = ImageFont.truetype("MahakXMusic/assets/font2.ttf", 30)
    font = ImageFont.truetype("MahakXMusic/assets/font.ttf", 30)
    title_font = ImageFont.truetype("MahakXMusic/assets/font3.ttf", 45)
    ...
    play_icons = Image.open("MahakXMusic/assets/play_icons.png")
